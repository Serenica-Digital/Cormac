...
| [024](024-product-naming-structure.md) | Naming structure: Serenica the company and platform; the product's working name is an open slot | Accepted (structure; name slot open) | 2026-06-10 |
