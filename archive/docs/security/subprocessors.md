...
| Infisical | Secret store (the secret authority, ADR-037) | Secret values only (Supabase service key, runtime/MCP tokens, model key); no business data | DPA; managed vs self-hosted choice; access control + read audit; region |
