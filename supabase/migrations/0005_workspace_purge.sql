-- Workspace purge: a deliberate, service-role-only deletion path. Ported from
-- v0 (archive/supabase/migrations/0005_workspace_purge.sql), proven live;
-- SQL unchanged.
--
...
-- is a control-plane decision like every other write. The flag is
